            ...
            <div>
                ...
                <Row className='about_row'>
                    <Col>
                        ...
                        <p className='about_paragraph'>As a Developer, I have full stack experience including:  React and Angular on the frontend, Java and python on the backend, and CI/CD with Jenkins for devops. While complex engineering problems are often intrinsically satisfying to solve, I’m most attracted to solving real customer problems with a business justification. I am currently looking for an internship for this summer 2021.</p>
                        <Button href="/skills" className='flow_btn flow_btn_about_row' variant="outline-light">My Skills</Button>
                    </Col>
